...
Maryam Ghaffari
![image](https://github.com/MarGhaf/Machine-Learning-Assisted-Raman-Spectroscopy/assets/101681195/58220b20-fda5-431f-b45a-096cbcfaf344)
...
![image](https://github.com/MarGhaf/Machine-Learning-Assisted-Raman-Spectroscopy/assets/101681195/6965302b-5f1b-4ce7-9677-172f1c257da3)
...
![image](https://github.com/MarGhaf/Machine-Learning-Assisted-Raman-Spectroscopy/assets/101681195/dfdb3738-0a6e-4678-83c1-6222bb07d253)

## Machine Learning Models
I trained 5 different machine learning classification models to classify the spectra. The models I used were the following:
- Logistic Regression
- Decision Tree
...
Overall, the results suggest that the Logistic Regression and FCNN models with preprocessing on data are the most effective for this particular Raman spectroscopy dataset. However, it is important to consider the specific goals of this project that is **fewer false negatives in  HT1080 and Hela cells and an elapse time of less than 60 seconds**. Based on the results **FCNN** is my selected model for practical use.

![image](https://github.com/MarGhaf/Machine-Learning-Assisted-Raman-Spectroscopy/assets/101681195/98dbe852-606e-4f82-803a-b4191ee183a8)

![image](https://github.com/MarGhaf/Machine-Learning-Assisted-Raman-Spectroscopy/assets/101681195/b2fac9f5-5499-478f-91db-7d23d2405b0e)
...
<p align="center">
<img width="460" height="300" src="https://github.com/MarGhaf/Machine-Learning-Assisted-Raman-Spectroscopy/assets/101681195/9e20179d-1069-4171-8d46-1a89f436fea1">
</p>

The exact interpretation of Raman peaks depends on factors such as molecular structure, chemical environment, and experimental conditions. According to the top 10 important features figure, peaks around 700, 850, and 1050 cm^-1  have  significant roles in predicting the type of EVs secreted from different cancerous cell types. Aromatic amino acids, including phenylalanine, tyrosine, and tryptophan, can contribute to Raman peaks in these regions in the context of biological samples. This finding helps scientists to identify specific molecules and study their roles in cell behaviors would be valuable in oncology studies. 
...
- Deploy the model: It is recommended to deploy the model that has shown good performance on the Raman spectroscopy dataset. The fully connected neural network with preprocessing has shown good results, and it can be used for further analysis.
...
- Develop a user-friendly interface: As mentioned in the business understanding, the current methods for Raman spectroscopy data analysis require specialized knowledge and expertise. Therefore, developing a user-friendly interface that can make Raman spectroscopy more accessible to non-expert users can be useful.
...
├── Images : Images used in capstone_project_presentation.pdf and README
├── capstone_project_presentation.pdf : Presentation for stakeholders
